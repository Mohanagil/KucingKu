...
<div class="container-fluid px-4">
    ...
    <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="ras" class="form-control" id="judul" name="judul" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Penulis</label>
            <input type="umur" class="form-control" id="judul" name="judul" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Isi Artikel</label>
            <textarea class="form-control" id="deskrispi" rows="5" style="overflow-y: scroll;"></textarea>
        </div>
        <div class="mb-3">
